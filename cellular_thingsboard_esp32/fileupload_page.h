...
<body>
  <p>Main page</p>
  <div id="serverStatus">Server Ready</div>
...
function rebootButton() {
  document.getElementById("serverStatus").innerHTML = "Invoking Reboot ...";
  var xhr = new XMLHttpRequest();
...
function downloadButton(filename, action){
...
function updateEspButton(filename, action){
  var urltocall = "/file?name=" + filename + "&action=" + action;
  xmlhttp=new XMLHttpRequest();
  if (action == "updateEsp") {
    document.getElementById("status").innerHTML = "";
...
function deleteButton(filename, action){
  var urltocall = "/file?name=" + filename + "&action=" + action;
  xmlhttp=new XMLHttpRequest();
  if (action == "delete") {
